...
class AnalogGaugeWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # DEFAULT SCALE VALUE
        ################################################################################################
        self.scale_angle_start_value = 0 #135
        self.scale_angle_size =  360 #270
    ...
    def setGaugeTheme(self, Theme=1):
        ...
        if Theme == 1:
            ...
            self.outer_circle_bg = [
                [0.0645161, QColor(30, 35, 45, 80)],
                [0.37788, QColor(57, 67, 86, 80)],
                [1, QColor(30, 36, 45, 80)]
            ]
    ...
    ################################################################################################
    # CREATE OUTER needle COVER
    ################################################################################################
    def draw_outer_circle(self, diameter=30):
        painter = QPainter(self)
        painter.setRenderHint(QPainter.Antialiasing)
        # Specify the angles for drawing half circle (180 degrees)
        start_angle = self.scale_angle_start_value / 10
    ...
    def draw_needle(self):
        ...
        # ])
        painter.rotate(((self.value - self.value_offset - self.minValue) * self.scale_angle_size /
                        (self.maxValue - self.minValue)) +180+ self.scale_angle_start_value)

        painter.drawConvexPolygon(pentagon)
